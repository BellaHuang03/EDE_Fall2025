...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, fig.cap="2018 monthly Ozone levels", fig.align='left', fig.width=6, fig.height=3}
library(dplyr)
library(ggplot2)
...
figure1
```
```{r, echo=FALSE, eval=TRUE, warning=FALSE, fig.cap="2019 monthly Ozone levels", fig.align='left', fig.width=6, fig.height=3}
figure2 <- epa_data %>%
  filter(Year==2019) %>%
  ggplot(aes(x = Month, y = Ozone))+
  geom_boxplot()+
...
## Git Repository
https://github.com/BellaHuang03/EDE_Fall2025
