...
fileholder <- here("Data","Raw")
files <- dir(fileholder, pattern = "EPAair_O3.*.", full.names = TRUE)
files
...
## What class is the dow column now?
class(usgs_flow_data$month)

#List the unique values in the column
unique(usgs_flow_data$month)
